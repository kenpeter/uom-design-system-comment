    ...
    window.UOMListFilter = function() {
      ...
      ListFilter = (function() {
        function ListFilter(el) {
          ...
          // Gary
          // el is form.filtered-listing-select, which is the form contains the intput checkboxes (i.e. filter checkbox)
          this.el = el;
  
          // Gary
          // function ListFilter(el) {....} is like the constructor
          //
          // "this" is ListFilter class definition:
          // ListFilter = (function() { <--------------------------
          //    function ListFilter(el) {
          t = this;
        ...
        ListFilter.prototype.hideTable = function(table, tag) {
